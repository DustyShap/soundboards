$(document).ready(function() {
  ...
  speakers = ['plowboy', 'doug', 'prodjoe', 'larry', 'tim', 'charlie', 'cat', 'timberfake', 'jayjr', 'mikelee']
  ...
  function doFirst() {
    ...
    theGrid.addEventListener("dragenter", function(e) {
      e.preventDefault();
    }, false);
    theGrid.addEventListener("dragover", function(e) {
      e.preventDefault();
    }, false);
  }
